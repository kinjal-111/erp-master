<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Customer - Pages Collapse Menu -->
      <li class="nav-item <?= $sidebarSection =='customer' ? 'active' : '';?>">
        ...
        data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?= $sidebarSubSection=='add' && $sidebarSection =='customer' ? 'active' : '';?>" 
                href="<?= BASEPAGES;?>add-customer.php">Add Customer</a>
            <a class="collapse-item <?= $sidebarSubSection=='manage' && $sidebarSection =='customer' ? 'active' : '';?>" 
      ...
      <!-- Nav Supplier - Pages Collapse Menu -->
      <li class="nav-item <?= $sidebarSection =='supplier' ? 'active' : '';?>">
        ...
        data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?= $sidebarSubSection=='add' && $sidebarSection =='supplier' ? 'active' : '';?>" 
                href="<?= BASEPAGES;?>add-supplier.php">Add Supplier</a>
            <a class="collapse-item <?= $sidebarSubSection=='manage' && $sidebarSection =='supplier' ? 'active' : '';?>" 
      ...
      <!-- Nav Product - Pages Collapse Menu -->
      <li class="nav-item <?= $sidebarSection =='product' ? 'active' : '';?>">
        ...
        data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?= $sidebarSubSection=='add' && $sidebarSection =='product' ? 'active' : '';?>" 
                href="<?= BASEPAGES;?>add-product.php">Add Product</a>
            <a class="collapse-item <?= $sidebarSubSection=='manage' && $sidebarSection =='product' ? 'active' : '';?>" 
      ...
      <!-- Nav Transaction - Pages Collapse Menu -->
      <li class="nav-item <?= $sidebarSection =='transaction' ? 'active' : '';?>">
        ...
        data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?= $sidebarSubSection=='sales' && $sidebarSection =='transaction' ? 'active' : '';?>" 
                href="<?= BASEPAGES;?>add-sales.php">Sale</a>
          </div>
        </div>
      </li>
