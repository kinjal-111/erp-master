...
class Validator
{
       ...
       protected $rules = ["required", "minlength", "maxlength", "unique", "uniqueCurrentRecord", "email"];
       protected $messages = [
              ...
              "uniqueCurrentRecord" => "This :field is already taken"
       ];
       /**
       ...
       */
       ...
       private function uniqueCurrentRecord($field, $value, $satisfier)
       {      
              $tableAndId = explode(".",$satisfier);
              //Util::dd($tableAndId);
              if($tableAndId[1] == 0)
                     return false;
              return !$this->database->existsCurrentRecord($satisfier,[$field=>$value],$tableAndId[0],$tableAndId[1]);
       }
