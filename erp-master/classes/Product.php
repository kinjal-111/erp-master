...
BUTTONS;
    ...
    public function getSPByProductID($product_id){
        return $this->database->readData('products_selling_rate', ['id', 'selling_rate', 'with_effect_from'], "product_id= {$product_id} and with_effect_from<= CURRENT_TIMESTAMP ORDER BY 3 DESC LIMIT 1");        
    }
}